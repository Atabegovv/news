...
import { Article, ArticleItemAPI, beautifulDate, RelatedArticlesAPI, Source as SourceType } from '../../types';
        ...
        <section className="article-page">
            ...
            <div className="container article-page__main">
                <div className="article-page__info">
                    ...
                    <span className="article-page__date">{beautifulDate(articleItem.date)}</span>
