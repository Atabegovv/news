    ...
    return (
        <section className="article-page">
            <article className="article">
                <section className="article__hero" style={{ backgroundImage: 'url("https://cojo.ru/wp-content/uploads/2022/12/stich-2-1.webp")' }}>
                ...
                <div className="grid container article__main">
                    <div className="article__content">
                        ...
                        <img src="https://cojo.ru/wp-content/uploads/2022/12/stich-2-1.webp" />
